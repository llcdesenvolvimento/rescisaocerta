  ...
  return <div ref={ref} className="bg-card rounded-2xl overflow-hidden shadow-xl border border-border max-w-md mx-auto w-full">
        ...
        <div className="px-5 pt-6 pb-4 text-center">
          ...
          <div className="bg-muted/50 rounded-[10px] py-6 px-4">
            <p className="text-base text-muted-foreground font-medium line-through">R$ 26,90</p>

            <p className="text-5xl font-black text-success tracking-tight mt-2">R$ 16,90</p>

            <div className="inline-flex items-center gap-1 mt-2 bg-success/10 border border-success/30 rounded-full px-3 py-1">
              <span className="text-[11px] font-extrabold text-success uppercase tracking-wide">Economize R$ 10,00</span>
            </div>
        ...
        <div className="px-5 pt-2 pb-5 space-y-5">
          {/* Nome + Email + CTA — logo após o card de preço */}
          <div className="space-y-3">
            <p className="text-foreground text-center font-semibold text-sm">
              Preencha suas informações para realizar o pagamento via Pix
            </p>
            <div>
            ...
            <div>
              <Input type="email" inputMode="email" autoComplete="email" placeholder="Seu e-mail" value={userEmail} onChange={e => onEmailChange(e.target.value)} className={cn("h-12 text-base", emailError && "border-destructive focus-visible:ring-destructive")} />
            </div>
            ...
            <p className="text-[11px] text-center text-muted-foreground">
              Acesso liberado na hora e enviado para o seu e-mail
            </p>
          </div>
          ...
          {/* Entregáveis — após o form, para apoiar a decisão */}
